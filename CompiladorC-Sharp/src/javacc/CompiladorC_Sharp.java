        ...
        public class CompiladorC_Sharp implements CompiladorC_SharpConstants {
                ...
                public static void Compilar(NewTabPanel ntp) throws ParseException, FileNotFoundException {
                        ...
                        try{
                                ...
                                ntp.getTxtTokens().setText(texto);
                                
                                ntp.getTxtSyntacticErrors().setText("");
                                ntp.getTxtSyntacticErrors().setText("No se encontraron errores sintácticos");
...
//                                }
                                ntp.getTxtSyntacticErrors().setText("");
                                ntp.getTxtSyntacticErrors().setText(e.getMessage());
                                
                                ntp.getTxtTokens().setText("");
                                ntp.getTxtTokens().setText("No se pudieron generar los tokens "
                                        + "\nporque se encontraron errores\nen el código");
